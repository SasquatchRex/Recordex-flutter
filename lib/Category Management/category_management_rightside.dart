...
class CategoryManagementRightSide extends StatefulWidget {
  const CategoryManagementRightSide({super.key});

  @override
  State<CategoryManagementRightSide> createState() => _CategoryManagementRightSideState();
}

class _CategoryManagementRightSideState extends State<CategoryManagementRightSide> {
  @override
